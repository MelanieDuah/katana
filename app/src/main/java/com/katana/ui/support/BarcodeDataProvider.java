...
public class BarcodeDataProvider implements LWPrintDataProvider {

    private static final String BARCODE_CONFIG_FILE = "barcode.plist";
     ...
     */
    public BarcodeDataProvider(AssetManager assetManager,
