...
/**
 * A Custom AlertDialog for use in the whole app when an alert is needed
 *
 * @author Akwasi Owusu
 */
public class KatanaAlertDialog extends AlertDialog.Builder {
    ...
    public static abstract class ButtonMethods implements Serializable {
        /**
